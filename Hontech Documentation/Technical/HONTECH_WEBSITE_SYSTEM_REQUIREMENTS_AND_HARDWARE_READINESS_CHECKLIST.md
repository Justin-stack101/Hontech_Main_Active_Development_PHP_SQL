...
Document Reference: HONTECH-SRS-CHK-2026-V2
Target Deployment Period: September 2026
...
Client Entity: HonTech AutoCenter (Management & Operations)
...
| **A.3** | **Front Desk / Service Assistant Computers** | **Branch 1 (Marikina Main)** | **1 PC** | • Windows 10/11 Desktop or Laptop<br>• 4GB+ RAM, Chrome / Edge browser<br>• 1080p or 1366x768 Display | [ ] PASS<br>[ ] FAIL |
| **A.4** | **Front Desk / Service Assistant Computers** | **Branch 2 (Expansion)** | **1 PC** | • Windows 10/11 Desktop or Laptop<br>• 4GB+ RAM, Chrome / Edge browser<br>• 1080p or 1366x768 Display | [ ] PASS<br>[ ] FAIL |
...
| **A.7** | **Uninterruptible Power Supply (UPS / AVR)** | **Front Desk / Server (Option A)** | **1–2 Units** | • 650VA–1000VA UPS with built-in surge suppressor to protect against voltage spikes | [ ] PASS<br>[ ] FAIL |
...
| :---: | :--- | :--- | :--- | :---: |
| **C.1** | **Primary Internet Bandwidth** | Fiber Broadband line (PLDT / Globe) tested at front desk and bay consoles | Minimum 15–25 Mbps Download / 10 Mbps Upload per branch | [ ] PASS<br>[ ] FAIL |
...
| **D.4** | **Service Assistant / Front Desk** | 2 Assistant Accounts (1 per branch) | Access to online booking intake arrivals and customer registration | [ ] PASS<br>[ ] FAIL |
...
### Category E: Shop Floor & Customer Lounge Setup
...
| **E.3** | **Physical Whiteboard Standby** | Shop Main Floor | Existing dry-erase whiteboard cleaned and markers ready for dual "Shadow Mode" | [ ] PASS<br>[ ] FAIL |
| **E.4** | **Printed Quick-Start User Guides** | Placed beside all 4 SA computers | 2-page laminated Quick Reference Card for instant staff lookup | [ ] PASS<br>[ ] FAIL |
...
* **Phase 2:** Developing Team and HonTech Management conduct the physical walk-through audit using this checklist.
* **Pre-requisite Gate:** All items under Categories A, B, C, and D must achieve a **PASS** rating before authorizing **Phase 3 Live Customer "Shadow Mode"**.
