...
| [`02_FREE_TIER_LIMITS_BANDWIDTH_AND_STORAGE_ECONOMICS.md`](./02_FREE_TIER_LIMITS_BANDWIDTH_AND_STORAGE_ECONOMICS.md) | **Free-Tier Economics & Limits** | Explaining 500 MB DB disk storage vs 100 GB bandwidth, why YouTube embeds use 0 MB, and why HonTech uses < 2% of quotas. |
