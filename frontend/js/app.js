...
`;
        ...
        function buildNavbar(role) {
            ...
            if (role === 'owner') {
                ...
                sidebarNavHTML += `<button onclick="launchTVMode()" class="w-full px-2.5 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2 text-gray-500 text-xs"><i data-lucide="monitor" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">TV Monitor</span></button>`;
