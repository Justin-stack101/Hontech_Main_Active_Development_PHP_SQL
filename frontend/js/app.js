...
`;
        ...
        function buildNavbar(role) {
            ...
            if (role === 'owner') {
                ...
                sidebarNavHTML += `<button onclick="showSection('dashboard', this)" class="nav-btn w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-600 text-xs"><i data-lucide="pie-chart" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">Analytics</span></button>`;
                sidebarNavHTML += `<button onclick="showSection('bays', this)" class="nav-btn w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-600 text-xs"><i data-lucide="layout-grid" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">Workshop Bays (View-Only)</span></button>`;
                sidebarNavHTML += `<button onclick="showSection('staff', this)" class="nav-btn w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-600 text-xs"><i data-lucide="users" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">Staff Access</span></button>`;
                sidebarNavHTML += `<button onclick="showSection('queue', this)" class="nav-btn w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-600 text-xs"><i data-lucide="database" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">Records</span></button>`;
                ...
                sidebarNavHTML += `<button onclick="showSection('dashboard', this)" class="nav-btn w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-600 text-xs"><i data-lucide="pie-chart" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">Analytics</span></button>`;
                sidebarNavHTML += `<button onclick="showSection('bays', this)" class="nav-btn w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-600 text-xs"><i data-lucide="layout-grid" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">Workshop Bays</span></button>`;
                sidebarNavHTML += `<button onclick="showSection('lookup', this)" class="nav-btn w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-600 text-xs"><i data-lucide="history" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">Customer Lookup</span></button>`;
                sidebarNavHTML += `<button onclick="showSection('staff', this)" class="nav-btn w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-600 text-xs"><i data-lucide="users" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">Staff Access</span></button>`;
                sidebarNavHTML += `<button onclick="showSection('queue', this)" class="nav-btn w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-600 text-xs"><i data-lucide="database" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">Records</span></button>`;
                ...
                sidebarNavHTML += `<button onclick="showSection('intake', this)" class="nav-btn w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-600 text-xs"><i data-lucide="calendar-plus" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">Online Bookings</span></button>`;
                sidebarNavHTML += `<button onclick="showSection('queue', this)" class="nav-btn w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-600 text-xs"><i data-lucide="list-todo" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">Master Queue</span></button>`;
                sidebarNavHTML += `<button onclick="showSection('lookup', this)" class="nav-btn w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-600 text-xs"><i data-lucide="history" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">Customer Lookup</span></button>`;
                sidebarNavHTML += `<button onclick="showSection('bays', this)" class="nav-btn w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-600 text-xs"><i data-lucide="layout-grid" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">Bay Status</span></button>`;
                sidebarNavHTML += `<button onclick="launchTVMode()" class="w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-500 text-xs"><i data-lucide="monitor" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">TV Monitor</span></button>`;
                ...
                sidebarNavHTML += `<button onclick="showSection('intake', this)" class="nav-btn w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-600 text-xs"><i data-lucide="user-plus" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">Walk-In Form</span></button>`;
                sidebarNavHTML += `<button onclick="showSection('queue', this)" class="nav-btn w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-600 text-xs"><i data-lucide="clipboard-list" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">Daily Intakes</span></button>`;
                sidebarNavHTML += `<button onclick="showSection('lookup', this)" class="nav-btn w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-600 text-xs"><i data-lucide="history" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">Customer Lookup</span></button>`;
                sidebarNavHTML += `<button onclick="showSection('bays', this)" class="nav-btn w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-600 text-xs"><i data-lucide="layout-grid" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">Bay Status</span></button>`;
                sidebarNavHTML += `<button onclick="launchTVMode()" class="w-full px-3 py-2 rounded-xl font-bold transition hover:bg-gray-100 flex items-center gap-2.5 text-gray-500 text-xs"><i data-lucide="monitor" class="w-4 h-4 shrink-0"></i><span class="nav-text whitespace-nowrap">TV Monitor</span></button>`;
