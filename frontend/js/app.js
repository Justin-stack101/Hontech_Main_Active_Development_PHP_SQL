...
`;
        ...
        function renderLegacyForm23Rows() {
            ...
            window.form23Items.forEach((item, index) => {
                ...
                html += `
                    <tr class="hover:bg-amber-50/40 transition">
                        <td class="py-1.5 px-2">
                            <input type="text" value="${escapeHtml(item.desc || '')}" oninput="updateLegacyForm23Item(${index}, 'desc', this.value)" placeholder="Part / Material Description" class="w-full bg-white border border-gray-200 rounded-lg px-2 py-1 text-xs font-semibold focus:border-amber-500 outline-none">
                        </td>
                        <td class="py-1.5 px-1 text-center">
                            <input type="number" min="1" value="${item.qty ?? 1}" oninput="updateLegacyForm23Item(${index}, 'qty', this.value)" class="w-12 text-center bg-white border border-gray-200 rounded-lg py-1 text-xs font-bold focus:border-amber-500 outline-none">
                        </td>
                        <td class="py-1.5 px-1 text-center">
                            <input type="number" step="0.1" min="0" value="${item.frt ?? 0}" oninput="updateLegacyForm23Item(${index}, 'frt', this.value)" class="w-12 text-center bg-white border border-gray-200 rounded-lg py-1 text-xs font-mono focus:border-amber-500 outline-none">
                        </td>
                        <td class="py-1.5 px-2 text-right">
                            <input type="number" step="10" min="0" value="${labor}" oninput="updateLegacyForm23Item(${index}, 'labor', this.value)" class="w-20 text-right bg-white border border-gray-200 rounded-lg px-2 py-1 text-xs font-mono font-bold focus:border-amber-500 outline-none">
                        </td>
                        <td class="py-1.5 px-2 text-right">
                            <input type="number" step="10" min="0" value="${parts}" oninput="updateLegacyForm23Item(${index}, 'parts', this.value)" class="w-20 text-right bg-white border border-gray-200 rounded-lg px-2 py-1 text-xs font-mono font-bold focus:border-amber-500 outline-none">
                        </td>
                        <td class="py-1.5 px-2 text-right">
                            <input type="number" step="10" min="0" value="${materials}" oninput="updateLegacyForm23Item(${index}, 'materials', this.value)" class="w-20 text-right bg-white border border-gray-200 rounded-lg px-2 py-1 text-xs font-mono font-bold focus:border-amber-500 outline-none">
                        </td>
                        ...
                        <td class="py-1.5 px-1 text-center">
                            <button type="button" onclick="removeLegacyForm23Row(${index})" class="text-gray-400 hover:text-red-600 transition p-1 cursor-pointer" title="Remove item">
                                <i data-lucide="trash-2" class="w-3.5 h-3.5"></i>
                            </button>
                        </td>
                    </tr>
        ...
        function updateLegacyForm23Item(index, key, value) {
            if (!window.form23Items[index]) return;
            if (key === 'desc') {
        ...
        function addLegacyForm23Row() {
            ...
            renderLegacyForm23Rows();
            calculateForm23Totals();
            syncForm23Canvas();
        }

        function removeLegacyForm23Row(index) {
        ...
        function syncLegacyForm23Canvas() {
            const getVal = id => (document.getElementById(id)?.value || '').trim();
