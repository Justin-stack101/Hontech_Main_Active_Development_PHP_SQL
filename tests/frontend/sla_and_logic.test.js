...
describe('Suite 13: Daily Intakes 3-Table Alignment, Spacing Rhythm & Command Deck (REV-082)', () => {
    ...
    describe('Suite 49: REV-121 Quotation_No & Billing_No Dynamic PDF Compiler & Form Alignment', () => {
        ...
        it('AUT-FRONT-151: REV-192 simple TV weather box (icon, temperature, condition) with the real reading', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.49"') || indexHtml.includes('src="js/app.js?v=3.48"') || indexHtml.includes('src="js/app.js?v=3.47"') || indexHtml.includes('src="js/app.js?v=3.46"') || indexHtml.includes('src="js/app.js?v=3.45"'), 'frontend/index.html must reference js/app.js?v=3.45 or higher');
        });
        ...
        it('AUT-FRONT-152: REV-193 Customer Lookup uses the RO Excel Studio sheet-tab design', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.49"') || indexHtml.includes('src="js/app.js?v=3.48"') || indexHtml.includes('src="js/app.js?v=3.47"') || indexHtml.includes('src="js/app.js?v=3.46"'), 'frontend/index.html must reference js/app.js?v=3.46 or higher');
        });
        ...
        it('AUT-FRONT-153: REV-194 Service_History records show real RO fields, back-job warranty and actions', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.49"') || indexHtml.includes('src="js/app.js?v=3.48"') || indexHtml.includes('src="js/app.js?v=3.47"'), 'frontend/index.html must reference js/app.js?v=3.47 or higher');
        });
        ...
        it('AUT-FRONT-154: REV-195 TV slides 1-3 are responsive and every area scrolls', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.49"') || indexHtml.includes('src="js/app.js?v=3.48"'), 'frontend/index.html must reference js/app.js?v=3.48 or higher');
        });
        ...
        it('AUT-FRONT-155: REV-196 TV auto-scrolls long lists and follows the Daily Intakes day (carry-overs stay)', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.49"'), 'frontend/index.html must reference js/app.js?v=3.49');
        });
    });
});
