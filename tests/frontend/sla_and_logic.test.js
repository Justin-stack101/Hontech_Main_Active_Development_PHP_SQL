...
describe('Suite 13: Daily Intakes 3-Table Alignment, Spacing Rhythm & Command Deck (REV-082)', () => {
    ...
    describe('Suite 34: REV-106 Form 1/3 Studio Right-Side PDF Preview & Hyphen-Free Daily Claim Stub Ranking', () => {
        it('AUT-FRONT-83: should verify form13-editor-pane and form13-canvas-pane are direct sibling columns and claim stub has no hyphen', () => {
            ...
            assert.strictEqual(
                indexHtml.includes('src="js/app.js?v=2.87"') || indexHtml.includes('src="js/app.js?v=2.86"') || indexHtml.includes('src="js/app.js?v=2.85"') || indexHtml.includes('src="js/app.js?v=2.84"') || indexHtml.includes('src="js/app.js?v=2.83"') || indexHtml.includes('src="js/app.js?v=2.82"') || indexHtml.includes('src="js/app.js?v=2.81"') || indexHtml.includes('src="js/app.js?v=2.80"') || indexHtml.includes('src="js/app.js?v=2.79"') || indexHtml.includes('src="js/app.js?v=2.78"') || indexHtml.includes('src="js/app.js?v=2.77"') || indexHtml.includes('src="js/app.js?v=2.76"') || indexHtml.includes('src="js/app.js?v=2.75"') || indexHtml.includes('src="js/app.js?v=2.74"') || indexHtml.includes('src="js/app.js?v=2.73"') || indexHtml.includes('src="js/app.js?v=2.72"') || indexHtml.includes('src="js/app.js?v=2.71"') || indexHtml.includes('src="js/app.js?v=2.70"') || indexHtml.includes('src="js/app.js?v=2.69"') || indexHtml.includes('src="js/app.js?v=2.68"') || indexHtml.includes('src="js/app.js?v=2.87"') || indexHtml.includes('src="js/app.js?v=2.86"') || indexHtml.includes('src="js/app.js?v=2.85"') || indexHtml.includes('src="js/app.js?v=2.84"') || indexHtml.includes('src="js/app.js?v=2.83"') || indexHtml.includes('src="js/app.js?v=2.82"') || indexHtml.includes('src="js/app.js?v=2.81"') || indexHtml.includes('src="js/app.js?v=2.80"') || indexHtml.includes('src="js/app.js?v=2.79"') || indexHtml.includes('src="js/app.js?v=2.78"') || indexHtml.includes('src="js/app.js?v=2.77"') || indexHtml.includes('src="js/app.js?v=2.76"') || indexHtml.includes('src="js/app.js?v=2.75"') || indexHtml.includes('src="js/app.js?v=2.74"') || indexHtml.includes('src="js/app.js?v=2.73"') || indexHtml.includes('src="js/app.js?v=2.72"') || indexHtml.includes('src="js/app.js?v=2.71"') || indexHtml.includes('src="js/app.js?v=2.70"') || indexHtml.includes('src="js/app.js?v=2.69"') || indexHtml.includes('src="js/app.js?v=2.68"') || indexHtml.includes('src="js/app.js?v=2.67"') || indexHtml.includes('src="js/app.js?v=2.66"') || indexHtml.includes('src="js/app.js?v=2.65"') || indexHtml.includes('src="js/app.js?v=2.64"') || indexHtml.includes('src="js/app.js?v=2.63"') || indexHtml.includes('src="js/app.js?v=2.62"'),
                true,
    ...
    describe('Suite 42: REV-114 SA 2025 RO Studio Live Multi-Sheet PDF Preview Sync, Exact Coordinates & 7-Sheet XLSX Export', () => {
        it('AUT-FRONT-91: Verifies reactive studio sync across all sheets, live sync badges, exact PDF coordinates, and v=2.70', () => {
            ...
            assert.strictEqual(
                (appJs.includes('drawTextFit(sa, 70, 165, 140, 7.5, true)') || appJs.includes('drawTextFit(sa, 70, 165, 140, 7.2, false)') || appJs.includes('drawTextFit(sa, 70, 145, 140, 7.2, false)')) &&
                (appJs.includes('drawTextFit(manager, 330, 165, 140, 7.5, true)') || appJs.includes('drawTextFit(manager, 330, 165, 140, 7.2, false)') || appJs.includes('drawTextFit(manager, 330, 145, 140, 7.2, false)')) &&
                (appJs.includes('drawTextFit(sa, 70, 215, 140, 7.5, true)') || appJs.includes('drawTextFit(sa, 70, 215, 140, 7.2, false)') || appJs.includes('drawTextFit(sa, 88, 95, 140, 7.2, false)')),
                true,
    ...
    describe('Suite 45: REV-117 SA 2025 RO Studio PDF Typography & Non-Bold Formatting Alignment with Excel Template', () => {
        it('AUT-FRONT-94: Verifies authentic regular non-bold fonts and exact text sizes matching Excel template', () => {
            ...
            assert.strictEqual(
                appJs.includes("drawTextFit(name, 134, 723.3, 140, 7.5, false);") &&
                appJs.includes("drawTextFit(plate, 472, 723.3, 48, 7.5, false);") &&
    ...
    describe('Suite 49: REV-121 Quotation_No & Billing_No Dynamic PDF Compiler & Form Alignment', () => {
        it('AUT-FRONT-98: Verifies drawTextCenter in quote & billing compilers, exact billing coordinates, table body lookup, and v=2.77', () => {
            ...
            assert.strictEqual(
                ...
                appJs.includes("whiteout(70, ry - 2, 405, rowStep);") &&
                appJs.includes("whiteout(25, ry - 2, 530, rowStep);"),
                true,
            ...
            assert.strictEqual(
                appJs.includes("const startY = 585.1;") &&
                appJs.includes("const rowStep = 11.58;") &&
                appJs.includes("drawTextRight(totalLabor.toFixed(2), 545, 168.1, 7.2, false);") &&
                appJs.includes("drawTextRight('PHP ' + grandTotal.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }), 545, 119.6, 8, true, darkInk);"),
                true,
                'compileBillingPDFBytes must use exact coordinates from authentic Billing template (startY 585.1, step 11.58, labor 168.1, total 119.6)'
            );
        ...
        it('AUT-FRONT-99: Verifies Senior SA Adaptive Auto-Magnifier defaults to OFF for 100% crisp vector resolution, absence of 5s timer, suppressed Loupe HUD, and cache buster v=2.81', () => {
            ...
            assert.strictEqual(
                indexHtml.includes('id="btn-studio-auto-magnify"') &&
                indexHtml.includes('id="label-studio-auto-magnify"') &&
                indexHtml.includes('Auto-Magnify: OFF') &&
                ...
                indexHtml.includes('setStudioManualZoom(1.85)'),
                true,
                'index.html must include Auto-Magnify toggle, zoom presets, and High-Definition Field Loupe HUDs across all 4 sheet canvas wrappers'
            );
            ...
            assert.strictEqual(
                ...
                (appJs.includes("isStudioAutoMagnifyEnabled = localStorage.getItem('hontech_studio_auto_magnify') !== 'false'") || appJs.includes("isStudioAutoMagnifyEnabled = localStorage.getItem('hontech_studio_auto_magnify') === 'true'")) &&
                !appJs.includes("studioMagnifier5sResetTimer") &&
            ...
            // 3. Verify reactive focus, input listeners, and responsive debounced PDF refresh to follow user typing
            assert.strictEqual(
                appJs.includes("applyStudioFieldMagnification(el)") &&
                appJs.includes("applyStudioFieldMagnification(e.target)") &&
                (appJs.includes("scheduleFormStudioPdfRefresh(600)") || appJs.includes("scheduleFormStudioPdfRefresh(400)")) &&
            ...
            assert.strictEqual(
                indexHtml.includes('src="js/app.js?v=2.87"') || indexHtml.includes('src="js/app.js?v=2.86"') || indexHtml.includes('src="js/app.js?v=2.85"') || indexHtml.includes('src="js/app.js?v=2.84"') || indexHtml.includes('src="js/app.js?v=2.83"') || indexHtml.includes('src="js/app.js?v=2.82"'),
                true,
        ...
        it('AUT-FRONT-100: Verifies Senior SA Follow-Along Auto-Magnifier with direct document zoom, natural glide-back auto-reset, crisp vector resolution, and cache buster v=2.83 (REV-127)', () => {
            ...
            assert.strictEqual(
                appJs.includes("studioMagnifierNaturalResetTimer") &&
                (appJs.includes("studioMagnifierNaturalResetTimer = setTimeout") || appJs.includes("lockStudioSection")) &&
                appJs.includes("resetStudioMagnification") &&
                appJs.includes("iframe.style.imageRendering = '-webkit-optimize-contrast'") &&
                appJs.includes("iframe.style.webkitFontSmoothing = 'antialiased'") &&
                (appJs.includes("activeStudioZoomScale = 1.55") || appJs.includes("activeStudioZoomScale = 0.88")),
                true,
            ...
            assert.strictEqual(
                indexHtml.includes('src="js/app.js?v=2.87"') || indexHtml.includes('src="js/app.js?v=2.86"') || indexHtml.includes('src="js/app.js?v=2.85"') || indexHtml.includes('src="js/app.js?v=2.84"') || indexHtml.includes('src="js/app.js?v=2.83"') || indexHtml.includes('src="js/app.js?v=2.87"') || indexHtml.includes('src="js/app.js?v=2.86"') || indexHtml.includes('src="js/app.js?v=2.85"') || indexHtml.includes('src="js/app.js?v=2.84"'),
                true,
                'index.html must increment cache buster to v=2.83 or v=2.84'
            );
        });

        it('AUT-FRONT-101: Verifies Option 1 High-Definition Super-Sampling (200% Layout & 0.5 Base Downsample) for Senior SA Studio with Razor-Sharp Crisp Zoom and cache buster v=2.84 (REV-128)', () => {
            const indexHtml = fs.readFileSync(path.resolve('frontend/index.html'), 'utf8');
            const appJs = fs.readFileSync(path.resolve('frontend/js/app.js'), 'utf8');

            // 1. Verify all 4 PDF iframes are wrapped in super-sampled viewports with w-[200%] h-[200%] and scale(0.5)
            assert.strictEqual(
                indexHtml.includes('id="f13-pdf-iframe" class="absolute top-0 left-0 w-[200%] h-[200%] border-0 bg-white" style="transform-origin: 0 0; transform: scale(0.5);') &&
                indexHtml.includes('id="f23-pdf-iframe" src="assets/Current_2025%20BLANK%20RO%20UPDATED.xlsx%20-%20Quotation_No.pdf#toolbar=1&navpanes=0" class="absolute top-0 left-0 w-[200%] h-[200%] border-0 bg-white" style="transform-origin: 0 0; transform: scale(0.5);') &&
                indexHtml.includes('id="billing-pdf-iframe" src="assets/Current_2025%20BLANK%20RO%20UPDATED.xlsx%20-%20Billing_No.pdf#toolbar=1&navpanes=0" class="absolute top-0 left-0 w-[200%] h-[200%] border-0 bg-white" style="transform-origin: 0 0; transform: scale(0.5);') &&
                indexHtml.includes('id="checklist-pdf-iframe" src="assets/Current_2025%20BLANK%20RO%20UPDATED.xlsx%20-%20CheckList_Result.pdf#toolbar=1&navpanes=0" class="absolute top-0 left-0 w-[200%] h-[200%] border-0 bg-white" style="transform-origin: 0 0; transform: scale(0.5);'),
                true,
                'index.html must equip all 4 PDF sheets with 200% super-sampling viewports and 0.5 scale downsample for zero blurriness'
            );

            // 2. Verify app.js uses super-sampled scale 0.88 for crisp vector zoom and 0.5 for natural reset
            assert.strictEqual(
                appJs.includes("activeStudioZoomScale = 0.88") &&
                appJs.includes("el.style.transformOrigin = '0 0'") &&
                (appJs.includes("el.style.transform = 'scale(0.5)'") || appJs.includes("scale(0.5)")) &&
                appJs.includes("studioMagnifierNaturalResetTimer") &&
                appJs.includes("scale: 0.88"),
                true,
                'app.js must implement 0.88 zoom scale and 0.5 reset scale for high-definition vector resolution without texture stretching'
            );

            // 3. Verify cache buster incremented to v=2.84 or v=2.85
            assert.strictEqual(
                indexHtml.includes('src="js/app.js?v=2.87"') || indexHtml.includes('src="js/app.js?v=2.86"') || indexHtml.includes('src="js/app.js?v=2.85"') || indexHtml.includes('src="js/app.js?v=2.84"'),
                true,
        ...
        it('AUT-FRONT-102: Verifies Full-Form Dynamic Follow-Along Auto-Magnifier with mathematical camera centering, table row delegation, and cache buster v=2.85 (REV-129)', () => {
            ...
            // 3. Verify mathematical camera centering engine (Target X/Y calculation and translation)
            assert.strictEqual(
                (appJs.includes("targetX = (containerW / 2) - (scale * px * iframeW)") || appJs.includes("targetX = (containerW - (scale * iframeW)) / 2")) &&
                (appJs.includes("targetY = (containerH / 2) - (scale * py * iframeH)") || appJs.includes("targetY = section.yRatio * maxScrollY;")) &&
                appJs.includes("translate(") &&
            ...
            assert.strictEqual(
                indexHtml.includes('src="js/app.js?v=2.87"') || indexHtml.includes('src="js/app.js?v=2.86"') || indexHtml.includes('src="js/app.js?v=2.85"'),
                true,
        ...
        it('AUT-FRONT-103: Verifies Hardcoded Section-Lock Navigation, Permanent Document Lock, and 1-Click Quick Lock Pills with cache buster v=2.86 (REV-130)', () => {
            ...
            // 1. Verify STUDIO_HARDCODED_SECTIONS has exact calibrated ratios
            assert.strictEqual(
                appJs.includes("STUDIO_HARDCODED_SECTIONS = {") &&
                appJs.includes("'customer': { yRatio: 0.0, scale: 0.88, label: 'CUSTOMER & VEHICLE' }") &&
                appJs.includes("'table': { yRatio: 0.50, scale: 0.88, label: 'PARTS & MATERIALS TABLE' }") &&
                appJs.includes("'signatures': { yRatio: 0.85, scale: 0.88, label: 'SIGNATURES & CONFORME' }") &&
                appJs.includes("'claim_stub': { yRatio: 1.00, scale: 0.88, label: 'CUSTOMER CLAIM STUB' }") &&
                appJs.includes("'chk_bottom': { yRatio: 1.00, scale: 0.88, label: 'REMARKS & FUEL GAUGE' }"),
                true,
            ...
            assert.strictEqual(
                ...
                appJs.includes("const maxScrollY = containerH - (scale * iframeH);") &&
                appJs.includes("const targetY = section.yRatio * maxScrollY;") &&
            ...
            // 3. Verify 1-Click Quick-Lock Navigation Pills in index.html across sheets
            assert.strictEqual(
                indexHtml.includes("lockStudioSection('fit')") &&
                indexHtml.includes("lockStudioSection('customer')") &&
                indexHtml.includes("lockStudioSection('table')") &&
                indexHtml.includes("lockStudioSection('signatures')") &&
                indexHtml.includes("lockStudioSection('claim_stub')") &&
                indexHtml.includes("lockStudioSection('chk_interior', 'checklist')"),
                true,
                'index.html must equip all 4 sheet viewers with 1-click Quick Lock navigation pills'
            );

            // 4. Verify cache buster incremented to v=2.86
            assert.strictEqual(
                indexHtml.includes('src="js/app.js?v=2.87"') || indexHtml.includes('src="js/app.js?v=2.86"'),
                true,
        ...
        it('AUT-FRONT-104: Verifies HD vector PDF templates, auto-magnifier default ON, debounced PDF refresh, and cache buster v=2.87 (REV-131)', () => {
            ...
            assert.strictEqual(
                appJs.includes("isStudioAutoMagnifyEnabled = localStorage.getItem('hontech_studio_auto_magnify') !== 'false'"),
                true,
            ...
            assert.strictEqual(
                appJs.includes("id.includes('part') || id.includes('material') || id.includes('quote-item') || id.includes('bill-item')") &&
                appJs.includes("id.includes('interior')") &&
                appJs.includes("id.includes('battery') || id.includes('hood') || id.includes('fluid')"),
                true,
            ...
            const hasScannedPageSlices = imgMatches.some(m => m.includes('622') || m.includes('623'));
            assert.strictEqual(hasScannedPageSlices, false, 'form13_template.pdf must eliminate low-res 622px scanned paper slices');

            // 5. Verify cache buster v=2.87
            assert.strictEqual(
                indexHtml.includes('src="js/app.js?v=2.87"'),
                true,
                'index.html must increment cache buster to v=2.87'
            );
        });
    });
});
