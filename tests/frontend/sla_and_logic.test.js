...
describe('Suite 13: Daily Intakes 3-Table Alignment, Spacing Rhythm & Command Deck (REV-082)', () => {
    ...
    describe('Suite 49: REV-121 Quotation_No & Billing_No Dynamic PDF Compiler & Form Alignment', () => {
        ...
        it('AUT-FRONT-117: REV-158 Billing Form 3/3 Measured Vector Alignment & Border-Safe Ghost Masking', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"') || indexHtml.includes('src="js/app.js?v=3.51"') || indexHtml.includes('src="js/app.js?v=3.50"') || indexHtml.includes('src="js/app.js?v=3.49"') || indexHtml.includes('src="js/app.js?v=3.48"') || indexHtml.includes('src="js/app.js?v=3.47"') || indexHtml.includes('src="js/app.js?v=3.46"') || indexHtml.includes('src="js/app.js?v=3.45"') || indexHtml.includes('src="js/app.js?v=3.44"') || indexHtml.includes('src="js/app.js?v=3.43"') || indexHtml.includes('src="js/app.js?v=3.42"') || indexHtml.includes('src="js/app.js?v=3.41"') || indexHtml.includes('src="js/app.js?v=3.40"') || indexHtml.includes('src="js/app.js?v=3.39"') || indexHtml.includes('src="js/app.js?v=3.38"') || indexHtml.includes('src="js/app.js?v=3.37"') || indexHtml.includes('src="js/app.js?v=3.36"') || indexHtml.includes('src="js/app.js?v=3.35"') || indexHtml.includes('src="js/app.js?v=3.34"') || indexHtml.includes('src="js/app.js?v=3.33"') || indexHtml.includes('src="js/app.js?v=3.32"') || indexHtml.includes('src="js/app.js?v=3.31"') || indexHtml.includes('src="js/app.js?v=3.30"') || indexHtml.includes('src="js/app.js?v=3.29"') || indexHtml.includes('src="js/app.js?v=3.28"') || indexHtml.includes('src="js/app.js?v=3.27"') || indexHtml.includes('src="js/app.js?v=3.26"') || indexHtml.includes('src="js/app.js?v=3.25"') || indexHtml.includes('src="js/app.js?v=3.24"') || indexHtml.includes('src="js/app.js?v=3.23"') || indexHtml.includes('src="js/app.js?v=3.22"') || indexHtml.includes('src="js/app.js?v=3.21"') || indexHtml.includes('src="js/app.js?v=3.20"') || indexHtml.includes('src="js/app.js?v=3.19"') || indexHtml.includes('src="js/app.js?v=3.18"') || indexHtml.includes('src="js/app.js?v=3.17"') || indexHtml.includes('src="js/app.js?v=3.16"') || indexHtml.includes('src="js/app.js?v=3.15"') || indexHtml.includes('src="js/app.js?v=3.14"') || indexHtml.includes('src="js/app.js?v=3.13"') || indexHtml.includes('src="js/app.js?v=3.12"') || indexHtml.includes('src="js/app.js?v=3.11"'), 'frontend/index.html must reference js/app.js?v=3.11 or higher');
        });
        ...
        it('AUT-FRONT-151: REV-192 simple TV weather box (icon, temperature, condition) with the real reading', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"') || indexHtml.includes('src="js/app.js?v=3.51"') || indexHtml.includes('src="js/app.js?v=3.50"') || indexHtml.includes('src="js/app.js?v=3.49"') || indexHtml.includes('src="js/app.js?v=3.48"') || indexHtml.includes('src="js/app.js?v=3.47"') || indexHtml.includes('src="js/app.js?v=3.46"') || indexHtml.includes('src="js/app.js?v=3.45"'), 'frontend/index.html must reference js/app.js?v=3.45 or higher');
        });
        ...
        it('AUT-FRONT-152: REV-193 Customer Lookup uses the RO Excel Studio sheet-tab design', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"') || indexHtml.includes('src="js/app.js?v=3.51"') || indexHtml.includes('src="js/app.js?v=3.50"') || indexHtml.includes('src="js/app.js?v=3.49"') || indexHtml.includes('src="js/app.js?v=3.48"') || indexHtml.includes('src="js/app.js?v=3.47"') || indexHtml.includes('src="js/app.js?v=3.46"'), 'frontend/index.html must reference js/app.js?v=3.46 or higher');
        });
        ...
        it('AUT-FRONT-153: REV-194 Service_History records show real RO fields, back-job warranty and actions', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"') || indexHtml.includes('src="js/app.js?v=3.51"') || indexHtml.includes('src="js/app.js?v=3.50"') || indexHtml.includes('src="js/app.js?v=3.49"') || indexHtml.includes('src="js/app.js?v=3.48"') || indexHtml.includes('src="js/app.js?v=3.47"'), 'frontend/index.html must reference js/app.js?v=3.47 or higher');
        });
        ...
        it('AUT-FRONT-154: REV-195 TV slides 1-3 are responsive and every area scrolls', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"') || indexHtml.includes('src="js/app.js?v=3.51"') || indexHtml.includes('src="js/app.js?v=3.50"') || indexHtml.includes('src="js/app.js?v=3.49"') || indexHtml.includes('src="js/app.js?v=3.48"'), 'frontend/index.html must reference js/app.js?v=3.48 or higher');
        });
        ...
        it('AUT-FRONT-155: REV-196 TV auto-scrolls long lists and follows the Daily Intakes day (carry-overs stay)', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"') || indexHtml.includes('src="js/app.js?v=3.51"') || indexHtml.includes('src="js/app.js?v=3.50"') || indexHtml.includes('src="js/app.js?v=3.49"'), 'frontend/index.html must reference js/app.js?v=3.49 or higher');
        });
        ...
        it('AUT-FRONT-156: REV-197 open TVs reload on a new TV page version; returned carry-overs are tagged', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"') || indexHtml.includes('src="js/app.js?v=3.51"') || indexHtml.includes('src="js/app.js?v=3.50"'), 'frontend/index.html must reference js/app.js?v=3.50 or higher');
        });
        ...
        it('AUT-FRONT-157: REV-198 HTML pages are never served from a stale browser cache', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"') || indexHtml.includes('src="js/app.js?v=3.51"'), 'frontend/index.html must reference js/app.js?v=3.51 or higher');
        });
        ...
        it('AUT-FRONT-158: REV-199 Excel claim stub rows match the PDF (plate | model, contact once)', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"'), 'frontend/index.html must reference js/app.js?v=3.52 or higher');
        });
        ...
        it('AUT-FRONT-159: REV-200 Job Order has no parts/materials editor; Quotation/Billing keep their own items', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.53"'), 'frontend/index.html must reference js/app.js?v=3.53');
        });
    });
});
