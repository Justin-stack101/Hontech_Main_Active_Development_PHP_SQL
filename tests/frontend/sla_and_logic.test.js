...
describe('Suite 13: Daily Intakes 3-Table Alignment, Spacing Rhythm & Command Deck (REV-082)', () => {
    ...
    describe('Suite 49: REV-121 Quotation_No & Billing_No Dynamic PDF Compiler & Form Alignment', () => {
        ...
        it('AUT-FRONT-117: REV-158 Billing Form 3/3 Measured Vector Alignment & Border-Safe Ghost Masking', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.27"') || indexHtml.includes('src="js/app.js?v=3.26"') || indexHtml.includes('src="js/app.js?v=3.25"') || indexHtml.includes('src="js/app.js?v=3.24"') || indexHtml.includes('src="js/app.js?v=3.23"') || indexHtml.includes('src="js/app.js?v=3.22"') || indexHtml.includes('src="js/app.js?v=3.21"') || indexHtml.includes('src="js/app.js?v=3.20"') || indexHtml.includes('src="js/app.js?v=3.19"') || indexHtml.includes('src="js/app.js?v=3.18"') || indexHtml.includes('src="js/app.js?v=3.17"') || indexHtml.includes('src="js/app.js?v=3.16"') || indexHtml.includes('src="js/app.js?v=3.15"') || indexHtml.includes('src="js/app.js?v=3.14"') || indexHtml.includes('src="js/app.js?v=3.13"') || indexHtml.includes('src="js/app.js?v=3.12"') || indexHtml.includes('src="js/app.js?v=3.11"'), 'frontend/index.html must reference js/app.js?v=3.11 or higher');
        });
        ...
        it('AUT-FRONT-125: REV-166 Brake Condition has an independent status per wheel across UI, PDF and Excel', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.27"') || indexHtml.includes('src="js/app.js?v=3.26"') || indexHtml.includes('src="js/app.js?v=3.25"') || indexHtml.includes('src="js/app.js?v=3.24"') || indexHtml.includes('src="js/app.js?v=3.23"') || indexHtml.includes('src="js/app.js?v=3.22"') || indexHtml.includes('src="js/app.js?v=3.21"') || indexHtml.includes('src="js/app.js?v=3.20"') || indexHtml.includes('src="js/app.js?v=3.19"'), 'frontend/index.html must reference js/app.js?v=3.19 or higher');
        });
        ...
        it('AUT-FRONT-126: REV-167 Checklist checkpoints are selection-only (no per-item notes box)', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.27"') || indexHtml.includes('src="js/app.js?v=3.26"') || indexHtml.includes('src="js/app.js?v=3.25"') || indexHtml.includes('src="js/app.js?v=3.24"') || indexHtml.includes('src="js/app.js?v=3.23"') || indexHtml.includes('src="js/app.js?v=3.22"') || indexHtml.includes('src="js/app.js?v=3.21"') || indexHtml.includes('src="js/app.js?v=3.20"'), 'frontend/index.html must reference js/app.js?v=3.20 or higher');
        });
        ...
        it('AUT-FRONT-127: REV-168 Checklist section headers use a gray band with black text', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.27"') || indexHtml.includes('src="js/app.js?v=3.26"') || indexHtml.includes('src="js/app.js?v=3.25"') || indexHtml.includes('src="js/app.js?v=3.24"') || indexHtml.includes('src="js/app.js?v=3.23"') || indexHtml.includes('src="js/app.js?v=3.22"') || indexHtml.includes('src="js/app.js?v=3.21"'), 'frontend/index.html must reference js/app.js?v=3.21 or higher');
        });
        ...
        it('AUT-FRONT-128: REV-169 Shared PDF toolbar and CheckList-style editors on Job Order, Quotation and Billing', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.27"') || indexHtml.includes('src="js/app.js?v=3.26"') || indexHtml.includes('src="js/app.js?v=3.25"') || indexHtml.includes('src="js/app.js?v=3.24"') || indexHtml.includes('src="js/app.js?v=3.23"') || indexHtml.includes('src="js/app.js?v=3.22"'), 'frontend/index.html must reference js/app.js?v=3.22 or higher');
        });
        ...
        it('AUT-FRONT-129: REV-170 PDF and Excel share one set of data, line-item and totals rules', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.27"') || indexHtml.includes('src="js/app.js?v=3.26"') || indexHtml.includes('src="js/app.js?v=3.25"') || indexHtml.includes('src="js/app.js?v=3.24"') || indexHtml.includes('src="js/app.js?v=3.23"'), 'frontend/index.html must reference js/app.js?v=3.23 or higher');
        });
        ...
        it('AUT-FRONT-130: REV-171 every RO Excel Studio section header has the tinted header band', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.27"') || indexHtml.includes('src="js/app.js?v=3.26"') || indexHtml.includes('src="js/app.js?v=3.25"') || indexHtml.includes('src="js/app.js?v=3.24"'), 'frontend/index.html must reference js/app.js?v=3.24 or higher');
        });
        ...
        it('AUT-FRONT-131: REV-172 studio section header bands use the neutral CheckList group gray', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.27"') || indexHtml.includes('src="js/app.js?v=3.26"') || indexHtml.includes('src="js/app.js?v=3.25"'), 'frontend/index.html must reference js/app.js?v=3.25 or higher');
        });
        ...
        it('AUT-FRONT-132: REV-173 Workshop_Monitoring studio tab holds the Workshop Monitoring & Daily Intakes entry', () => {
            ...
            ['f13-input-claim-stub', 'f13-input-arrival-time', 'f13-input-target-branch', 'f13-input-source', 'f13-input-lane-type', 'f13-input-bay-location', 'f13-input-parts-status', 'f13-input-status', 'f13-input-carry-over']
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.27"') || indexHtml.includes('src="js/app.js?v=3.26"'), 'frontend/index.html must reference js/app.js?v=3.26 or higher');
        });
        ...
        it('AUT-FRONT-133: REV-174 Workshop_Monitoring is the first studio tab, then Job_Order, Quotation_No, Billing_No, CheckList_Result', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.27"'), 'frontend/index.html must reference js/app.js?v=3.27');
        });
    });
});
