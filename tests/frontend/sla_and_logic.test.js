...
describe('Suite 13: Daily Intakes 3-Table Alignment, Spacing Rhythm & Command Deck (REV-082)', () => {
    ...
    describe('Suite 34: REV-106 Form 1/3 Studio Right-Side PDF Preview & Hyphen-Free Daily Claim Stub Ranking', () => {
        it('AUT-FRONT-83: should verify form13-editor-pane and form13-canvas-pane are direct sibling columns and claim stub has no hyphen', () => {
            ...
            assert.strictEqual(
                indexHtml.includes('src="js/app.js?v=2.80"') || indexHtml.includes('src="js/app.js?v=2.79"') || indexHtml.includes('src="js/app.js?v=2.78"') || indexHtml.includes('src="js/app.js?v=2.77"') || indexHtml.includes('src="js/app.js?v=2.76"') || indexHtml.includes('src="js/app.js?v=2.75"') || indexHtml.includes('src="js/app.js?v=2.74"') || indexHtml.includes('src="js/app.js?v=2.73"') || indexHtml.includes('src="js/app.js?v=2.72"') || indexHtml.includes('src="js/app.js?v=2.71"') || indexHtml.includes('src="js/app.js?v=2.70"') || indexHtml.includes('src="js/app.js?v=2.69"') || indexHtml.includes('src="js/app.js?v=2.68"') || indexHtml.includes('src="js/app.js?v=2.80"') || indexHtml.includes('src="js/app.js?v=2.79"') || indexHtml.includes('src="js/app.js?v=2.78"') || indexHtml.includes('src="js/app.js?v=2.77"') || indexHtml.includes('src="js/app.js?v=2.76"') || indexHtml.includes('src="js/app.js?v=2.75"') || indexHtml.includes('src="js/app.js?v=2.74"') || indexHtml.includes('src="js/app.js?v=2.73"') || indexHtml.includes('src="js/app.js?v=2.72"') || indexHtml.includes('src="js/app.js?v=2.71"') || indexHtml.includes('src="js/app.js?v=2.70"') || indexHtml.includes('src="js/app.js?v=2.69"') || indexHtml.includes('src="js/app.js?v=2.68"') || indexHtml.includes('src="js/app.js?v=2.67"') || indexHtml.includes('src="js/app.js?v=2.66"') || indexHtml.includes('src="js/app.js?v=2.65"') || indexHtml.includes('src="js/app.js?v=2.64"') || indexHtml.includes('src="js/app.js?v=2.63"') || indexHtml.includes('src="js/app.js?v=2.62"'),
                true,
    ...
    describe('Suite 45: REV-117 SA 2025 RO Studio PDF Typography & Non-Bold Formatting Alignment with Excel Template', () => {
        it('AUT-FRONT-94: Verifies authentic regular non-bold fonts and exact text sizes matching Excel template', () => {
            ...
            assert.strictEqual(
                indexHtml.includes('src="js/app.js?v=2.80"') || indexHtml.includes('src="js/app.js?v=2.79"') || indexHtml.includes('src="js/app.js?v=2.78"') || indexHtml.includes('src="js/app.js?v=2.77"') || indexHtml.includes('src="js/app.js?v=2.76"') || indexHtml.includes('src="js/app.js?v=2.75"') || indexHtml.includes('src="js/app.js?v=2.74"') || indexHtml.includes('src="js/app.js?v=2.73"'),
                true,
    ...
    describe('Suite 46: REV-118 Migration to Current_2025 BLANK RO UPDATED_V1.xlsx Official Export Template', () => {
        it('AUT-FRONT-95: Verifies V1 template loading and Sheet 7 dynamic formula coordinate injection', () => {
            ...
            assert.strictEqual(
                indexHtml.includes('src="js/app.js?v=2.80"') || indexHtml.includes('src="js/app.js?v=2.79"') || indexHtml.includes('src="js/app.js?v=2.78"') || indexHtml.includes('src="js/app.js?v=2.77"') || indexHtml.includes('src="js/app.js?v=2.76"') || indexHtml.includes('src="js/app.js?v=2.75"') || indexHtml.includes('src="js/app.js?v=2.74"'),
                true,
    ...
    describe('Suite 47: REV-119 Service Advisor Receiving Checklist Color Status Stamping & Studio Controls', () => {
        it('AUT-FRONT-96: Verifies multi-point checklist color stamping, fuel gauge marking, C63 technician injection, and v=2.75', () => {
            ...
            assert.strictEqual(
                indexHtml.includes('src="js/app.js?v=2.80"') || indexHtml.includes('src="js/app.js?v=2.79"') || indexHtml.includes('src="js/app.js?v=2.78"') || indexHtml.includes('src="js/app.js?v=2.77"') || indexHtml.includes('src="js/app.js?v=2.76"') || indexHtml.includes('src="js/app.js?v=2.75"'),
                true,
    ...
    describe('Suite 48: REV-120 SA Checklist Completeness & Stamping Verification', () => {
        it('AUT-FRONT-97: Verifies interior_light, hydraulic_clutch, drive_shaft, brakes not inspected toggle & M37 stamping, and v=2.76', () => {
            ...
            assert.strictEqual(
                indexHtml.includes('src="js/app.js?v=2.80"') || indexHtml.includes('src="js/app.js?v=2.79"') || indexHtml.includes('src="js/app.js?v=2.78"') || indexHtml.includes('src="js/app.js?v=2.77"') || indexHtml.includes('src="js/app.js?v=2.76"'),
                true,
    ...
    describe('Suite 49: REV-121 Quotation_No & Billing_No Dynamic PDF Compiler & Form Alignment', () => {
        it('AUT-FRONT-98: Verifies drawTextCenter in quote & billing compilers, exact billing coordinates, table body lookup, and v=2.77', () => {
            ...
            assert.strictEqual(
                ...
                (indexHtml.includes('src="js/app.js?v=2.80"') || indexHtml.includes('src="js/app.js?v=2.79"') || indexHtml.includes('src="js/app.js?v=2.78"') || indexHtml.includes('src="js/app.js?v=2.77"')),
                true,
                'index.html must include # column in Billing thead and increment cache buster'
            );
        });

        it('AUT-FRONT-99: Verifies Senior SA Adaptive Auto-Magnifier follow-along engine, suppressed Loupe HUD, absence of 5s reset timer, and cache buster v=2.80', () => {
            const indexHtml = fs.readFileSync(path.resolve('frontend/index.html'), 'utf8');
            const appJs = fs.readFileSync(path.resolve('frontend/js/app.js'), 'utf8');

            // 1. Verify Auto-Magnify toolbar button, presets, and suppressed Field Loupe HUD in index.html
            assert.strictEqual(
                ...
                indexHtml.includes('style="display: none !important;"') &&
                ...
                true,
                'index.html must include Auto-Magnify toggle, zoom presets, and permanently suppressed Field Loupe HUDs across all 4 sheet canvas wrappers'
            );

            // 2. Verify Senior SA Adaptive Magnifier Engine & Document Zone Coordinates in app.js without 5-second reset
            assert.strictEqual(
                ...
                true,
                'app.js must implement STUDIO_MAGNIFIER_ZONES with exact document coordinates and follow-along focus without 5-second auto-reset timer rule'
            );
            ...
            // 4. Verify cache buster v=2.80
            assert.strictEqual(
                indexHtml.includes('src="js/app.js?v=2.80"'),
                true,
                'index.html must increment cache buster to v=2.80'
            );
        });
    });
});
