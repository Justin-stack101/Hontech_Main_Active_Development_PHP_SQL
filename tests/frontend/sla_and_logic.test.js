...
describe('Suite 13: Daily Intakes 3-Table Alignment, Spacing Rhythm & Command Deck (REV-082)', () => {
    ...
    describe('Suite 34: REV-106 Form 1/3 Studio Right-Side PDF Preview & Hyphen-Free Daily Claim Stub Ranking', () => {
        it('AUT-FRONT-83: should verify form13-editor-pane and form13-canvas-pane are direct sibling columns and claim stub has no hyphen', () => {
            ...
            assert.strictEqual(
                ((((indexHtml.includes('src="js/app.js?v=3.04"') || indexHtml.includes('src="js/app.js?v=3.03"') || indexHtml.includes('src="js/app.js?v=3.02"')) || indexHtml.includes('src="js/app.js?v=3.01"')) || indexHtml.includes('src="js/app.js?v=3.00"')) || indexHtml.includes('src="js/app.js?v=2.99"') || indexHtml.includes('src="js/app.js?v=2.98"')) || indexHtml.includes('src="js/app.js?v=2.97"') || indexHtml.includes('src="js/app.js?v=2.96"') || indexHtml.includes('src="js/app.js?v=2.95"') || indexHtml.includes('src="js/app.js?v=2.94"') || indexHtml.includes('src="js/app.js?v=2.93"') || indexHtml.includes('src="js/app.js?v=2.92"') || indexHtml.includes('src="js/app.js?v=2.91"') || indexHtml.includes('src="js/app.js?v=2.90"') || indexHtml.includes('src="js/app.js?v=2.89"') || indexHtml.includes('src="js/app.js?v=2.88"') || indexHtml.includes('src="js/app.js?v=2.87"') || indexHtml.includes('src="js/app.js?v=2.86"') || indexHtml.includes('src="js/app.js?v=2.85"') || indexHtml.includes('src="js/app.js?v=2.84"') || indexHtml.includes('src="js/app.js?v=2.83"') || indexHtml.includes('src="js/app.js?v=2.82"') || indexHtml.includes('src="js/app.js?v=2.81"') || indexHtml.includes('src="js/app.js?v=2.80"') || indexHtml.includes('src="js/app.js?v=2.79"') || indexHtml.includes('src="js/app.js?v=2.78"') || indexHtml.includes('src="js/app.js?v=2.77"') || indexHtml.includes('src="js/app.js?v=2.76"') || indexHtml.includes('src="js/app.js?v=2.75"') || indexHtml.includes('src="js/app.js?v=2.74"') || indexHtml.includes('src="js/app.js?v=2.73"') || indexHtml.includes('src="js/app.js?v=2.72"') || indexHtml.includes('src="js/app.js?v=2.71"') || indexHtml.includes('src="js/app.js?v=2.70"') || indexHtml.includes('src="js/app.js?v=2.69"') || indexHtml.includes('src="js/app.js?v=2.68"') || ((((indexHtml.includes('src="js/app.js?v=3.04"') || indexHtml.includes('src="js/app.js?v=3.03"') || indexHtml.includes('src="js/app.js?v=3.02"')) || indexHtml.includes('src="js/app.js?v=3.01"')) || indexHtml.includes('src="js/app.js?v=3.00"')) || indexHtml.includes('src="js/app.js?v=2.99"') || indexHtml.includes('src="js/app.js?v=2.98"')) || indexHtml.includes('src="js/app.js?v=2.97"') || indexHtml.includes('src="js/app.js?v=2.96"') || indexHtml.includes('src="js/app.js?v=2.95"') || indexHtml.includes('src="js/app.js?v=2.94"') || indexHtml.includes('src="js/app.js?v=2.93"') || indexHtml.includes('src="js/app.js?v=2.92"') || indexHtml.includes('src="js/app.js?v=2.91"') || indexHtml.includes('src="js/app.js?v=2.90"') || indexHtml.includes('src="js/app.js?v=2.89"') || indexHtml.includes('src="js/app.js?v=2.88"') || indexHtml.includes('src="js/app.js?v=2.87"') || indexHtml.includes('src="js/app.js?v=2.86"') || indexHtml.includes('src="js/app.js?v=2.85"') || indexHtml.includes('src="js/app.js?v=2.84"') || indexHtml.includes('src="js/app.js?v=2.83"') || indexHtml.includes('src="js/app.js?v=2.82"') || indexHtml.includes('src="js/app.js?v=2.81"') || indexHtml.includes('src="js/app.js?v=2.80"') || indexHtml.includes('src="js/app.js?v=2.79"') || indexHtml.includes('src="js/app.js?v=2.78"') || indexHtml.includes('src="js/app.js?v=2.77"') || indexHtml.includes('src="js/app.js?v=2.76"') || indexHtml.includes('src="js/app.js?v=2.75"') || indexHtml.includes('src="js/app.js?v=2.74"') || indexHtml.includes('src="js/app.js?v=2.73"') || indexHtml.includes('src="js/app.js?v=2.72"') || indexHtml.includes('src="js/app.js?v=2.71"') || indexHtml.includes('src="js/app.js?v=2.70"') || indexHtml.includes('src="js/app.js?v=2.69"') || indexHtml.includes('src="js/app.js?v=2.68"') || indexHtml.includes('src="js/app.js?v=2.67"') || indexHtml.includes('src="js/app.js?v=2.66"') || indexHtml.includes('src="js/app.js?v=2.65"') || indexHtml.includes('src="js/app.js?v=2.64"') || indexHtml.includes('src="js/app.js?v=2.63"') || indexHtml.includes('src="js/app.js?v=2.62"'),
                true,
    ...
    describe('Suite 45: REV-117 SA 2025 RO Studio PDF Typography & Non-Bold Formatting Alignment with Excel Template', () => {
        it('AUT-FRONT-94: Verifies authentic regular non-bold fonts and exact text sizes matching Excel template', () => {
            ...
            assert.strictEqual(
                (appJs.includes("drawTextFit(name, 148, 715.8, 138, 6.2, false, darkInk, 5.0);") || appJs.includes("drawTextFit(name, 148, 715.8, 138, 6.5, false, darkInk, 5.2);")) &&
                (appJs.includes("drawTextFit(plate, 464, 715.8, 44, 6.2, false, darkInk, 5.0);") || appJs.includes("drawTextFit(plate, 464, 715.8, 44, 6.5, true, darkInk, 5.2);")) &&
                (appJs.includes("drawTextCenter(sa, 196.5, 583.5, 6.5, false);") || appJs.includes("drawTextCenter(sa, 187.5, 549.5, 6.5, false);") || appJs.includes("drawTextCenter(sa, 184, 583.5, 7.5, false);")) &&
                (appJs.includes("drawTextCenter(mechanic, 200.0, 290.0, 6.5, false);") || appJs.includes("drawTextCenter(mechanic, 200.0, 292.0, 6.5, false);") || appJs.includes("drawTextCenter(mechanic, 215.0, 274.8, 6.5, false);") || appJs.includes("drawTextCenter(mechanic, 184, 279.8, 7.2, false);")) &&
                (appJs.includes("drawTextFit(sa, 152, 89.5, 132, 6.2, false);") || appJs.includes("drawTextFit(sa, 152, 84.0, 132, 6.2, false);") || appJs.includes("drawTextFit(sa, 175, 69.1, 100, 7.5, false);")),
                true,
            ...
            assert.strictEqual(
                (appJs.includes("drawText(quoteNo, 420, 776.6, 8, true, darkInk);") || appJs.includes("drawText(quoteNo, 420, 775.5, 8, true, darkInk);")) &&
                (appJs.includes("drawTextFit(name, 115, 696.5, 180, 6.5, false, darkInk, 5.2);") || appJs.includes("drawTextFit(name, 115, 696.3, 180, 6.5, false, darkInk, 5.2);")) &&
            ...
            assert.strictEqual(
                indexHtml.includes('src="js/app.js?v=3.04"') || indexHtml.includes('src="js/app.js?v=3.04"') || indexHtml.includes('src="js/app.js?v=3.03"') || indexHtml.includes('src="js/app.js?v=3.02"') || indexHtml.includes('src="js/app.js?v=3.01"') || indexHtml.includes('src="js/app.js?v=3.00"') || indexHtml.includes('src="js/app.js?v=2.99"') || indexHtml.includes('src="js/app.js?v=2.98"'),
                true,
        ...
        it('AUT-FRONT-106: REV-144 Form 1/3 Underline Precision, Line Clearance & Boundary Padding', () => {
            ...
            assert.strictEqual(
                ...
                (appJs.includes("drawTextFit(contact, 148, 700.3, 138, 6.2, false, darkInk, 5.0);") || appJs.includes("drawTextFit(contact, 148, 700.3, 138, 6.5, false, darkInk, 5.2);")) &&
            ...
            assert.strictEqual(
                (appJs.includes("drawTextFit(model, 350, 715.8, 62, 6.2, false, darkInk, 5.0);") || appJs.includes("drawTextFit(model, 350, 715.8, 62, 6.5, false, darkInk, 5.2);")) &&
                (appJs.includes("drawTextFit(km, 350, 708.0, 62, 6.2, false, darkInk, 5.0);") || appJs.includes("drawTextFit(km, 350, 708.0, 62, 6.5, false, darkInk, 5.2);")) &&
                (appJs.includes("drawTextFit(engine, 350, 700.3, 62, 6.2, false, darkInk, 5.0);") || appJs.includes("drawTextFit(engine, 350, 700.3, 62, 6.5, false, darkInk, 5.2);")) &&
                (appJs.includes("drawTextFit(chassis, 350, 692.5, 62, 6.2, false, darkInk, 5.0);") || appJs.includes("drawTextFit(chassis, 350, 692.5, 62, 6.5, false, darkInk, 5.2);")),
                true,
        ...
        it('AUT-FRONT-107: REV-146 Quotation, Billing, and Checklist Multi-Sheet Precision Alignment & Placeholder Masking', () => {
            ...
            assert.strictEqual(
                appJs.includes("drawText(quoteNo, 420, 775.5, 8, true, darkInk);") &&
                appJs.includes("drawText(date, 470, 743.5, 7.5, false, darkInk);") &&
                (appJs.includes("whiteout(475, 729.5, 65, 10);") || appJs.includes("whiteout(420, 720, 100, 62);")) &&
                appJs.includes("drawText(jobNo, 485, 734.0, 7.5, true, darkInk);") &&
                appJs.includes("drawTextFit(name, 115, 696.3, 180, 6.5, false, darkInk, 5.2);") &&
                appJs.includes("drawTextFit(plate, 380, 696.3, 120, 6.5, true, darkInk, 5.2);") &&
                appJs.includes("whiteout(72, ry - 1.5, 120, 8.5);"),
                true,
    ...
    describe('Suite 49: REV-121 Quotation_No & Billing_No Dynamic PDF Compiler & Form Alignment', () => {
        it('AUT-FRONT-98: Verifies drawTextCenter in quote & billing compilers, exact billing coordinates, table body lookup, and v=2.77', () => {
            ...
            assert.strictEqual(
                ...
                (appJs.includes("whiteout(70, ry - 2, 405, rowStep);") || appJs.includes("whiteout(72, ry - 1.5, 120, 8.5);")) &&
        ...
        it('AUT-FRONT-100: Verifies Senior SA Follow-Along Auto-Magnifier with direct document zoom, natural glide-back auto-reset, crisp vector resolution, and cache buster v=2.83 (REV-127)', () => {
            ...
            assert.strictEqual(
                ((((indexHtml.includes('src="js/app.js?v=3.04"') || indexHtml.includes('src="js/app.js?v=3.03"') || indexHtml.includes('src="js/app.js?v=3.02"')) || indexHtml.includes('src="js/app.js?v=3.01"')) || indexHtml.includes('src="js/app.js?v=3.00"')) || indexHtml.includes('src="js/app.js?v=2.99"') || indexHtml.includes('src="js/app.js?v=2.98"')) || indexHtml.includes('src="js/app.js?v=2.97"') || indexHtml.includes('src="js/app.js?v=2.96"') || indexHtml.includes('src="js/app.js?v=2.95"') || indexHtml.includes('src="js/app.js?v=2.94"') || indexHtml.includes('src="js/app.js?v=2.93"') || indexHtml.includes('src="js/app.js?v=2.92"') || indexHtml.includes('src="js/app.js?v=2.91"') || indexHtml.includes('src="js/app.js?v=2.90"') || indexHtml.includes('src="js/app.js?v=2.89"') || indexHtml.includes('src="js/app.js?v=2.88"') || indexHtml.includes('src="js/app.js?v=2.87"') || indexHtml.includes('src="js/app.js?v=2.86"') || indexHtml.includes('src="js/app.js?v=2.85"') || indexHtml.includes('src="js/app.js?v=2.84"') || indexHtml.includes('src="js/app.js?v=2.83"') || ((((indexHtml.includes('src="js/app.js?v=3.04"') || indexHtml.includes('src="js/app.js?v=3.03"') || indexHtml.includes('src="js/app.js?v=3.02"')) || indexHtml.includes('src="js/app.js?v=3.01"')) || indexHtml.includes('src="js/app.js?v=3.00"')) || indexHtml.includes('src="js/app.js?v=2.99"') || indexHtml.includes('src="js/app.js?v=2.98"')) || indexHtml.includes('src="js/app.js?v=2.97"') || indexHtml.includes('src="js/app.js?v=2.96"') || indexHtml.includes('src="js/app.js?v=2.95"') || indexHtml.includes('src="js/app.js?v=2.94"') || indexHtml.includes('src="js/app.js?v=2.93"') || indexHtml.includes('src="js/app.js?v=2.92"') || indexHtml.includes('src="js/app.js?v=2.91"') || indexHtml.includes('src="js/app.js?v=2.90"') || indexHtml.includes('src="js/app.js?v=2.89"') || indexHtml.includes('src="js/app.js?v=2.88"') || indexHtml.includes('src="js/app.js?v=2.87"') || indexHtml.includes('src="js/app.js?v=2.86"') || indexHtml.includes('src="js/app.js?v=2.85"') || indexHtml.includes('src="js/app.js?v=2.84"'),
                true,
        ...
        it('AUT-FRONT-104: Verifies HD vector PDF templates, auto-magnifier default ON, debounced PDF refresh, and cache buster v=2.87 (REV-131)', () => {
            ...
            assert.strictEqual(
                ((((indexHtml.includes('src="js/app.js?v=3.04"') || indexHtml.includes('src="js/app.js?v=3.03"') || indexHtml.includes('src="js/app.js?v=3.02"')) || indexHtml.includes('src="js/app.js?v=3.01"')) || indexHtml.includes('src="js/app.js?v=3.00"')) || indexHtml.includes('src="js/app.js?v=2.99"') || indexHtml.includes('src="js/app.js?v=2.98"')) || indexHtml.includes('src="js/app.js?v=2.97"') || indexHtml.includes('src="js/app.js?v=2.96"') || indexHtml.includes('src="js/app.js?v=2.95"') || indexHtml.includes('src="js/app.js?v=2.94"') || indexHtml.includes('src="js/app.js?v=2.93"') || indexHtml.includes('src="js/app.js?v=2.92"') || indexHtml.includes('src="js/app.js?v=2.91"') || indexHtml.includes('src="js/app.js?v=2.90"') || indexHtml.includes('src="js/app.js?v=2.89"') || indexHtml.includes('src="js/app.js?v=2.88"') || indexHtml.includes('src="js/app.js?v=2.87"'),
                true,
