...
describe('Suite 13: Daily Intakes 3-Table Alignment, Spacing Rhythm & Command Deck (REV-082)', () => {
    ...
    describe('Suite 31: REV-102 2025 RO Studio Workshop Monitoring & Daily Intakes Dispatch Card', () => {
        it('AUT-FRONT-79: should verify Form 1/3 top monitoring dispatch card, auto-prefilled claim stub and arrival time, and 1-button registration payload binding', () => {
            ...
            [
                ...
                'f13-input-source',
                'f13-input-lane-type',
                // REV-202: Carry-Over (C.O.) choice removed (carry-over is set from Daily Intakes)
    ...
    describe('Suite 32: REV-104 Step 1 Workshop Monitoring First Workflow & Daily Claim Stub Ranking', () => {
        it('AUT-FRONT-80: should verify monitoring card is Card #1 before job header, contains full-width register button, and claim stub ranks J1, J2, J3', () => {
            ...
            assert.strictEqual(
                jobController.includes("return $datePrefix . 'J' . $next;"), // REV-203: server counter per day
                true,
    ...
    describe('Suite 34: REV-106 Form 1/3 Studio Right-Side PDF Preview & Hyphen-Free Daily Claim Stub Ranking', () => {
        it('AUT-FRONT-83: should verify form13-editor-pane and form13-canvas-pane are direct sibling columns and claim stub has no hyphen', () => {
            ...
            assert.strictEqual(
                jobController.includes("return $datePrefix . 'J' . $next;") && !jobController.includes("'-J'"), // REV-203
                true,
    ...
    describe('Suite 40: REV-112 Precise Excel Cell Coordinate Injection & Multi-Column Pricing Architecture', () => {
        it('AUT-FRONT-89: Verifies exact signature alignments, customer claim stub cells, multi-column pricing (A, C, D, E, F, G, H), and checklist date M5', () => {
            ...
            assert.strictEqual(
                appJs.includes("setCell(sheet1Doc, 'H70', plate)") && appJs.includes("setCell(sheet1Doc, 'J70', model)"),
                true,
                'exportOfficialXLSX must inject Claim Stub plate into H70 and year/model into J70 (REV-199: not into the gap cell I70)'
            );
            assert.strictEqual(
    ...
    describe('Suite 42: REV-114 SA 2025 RO Studio Live Multi-Sheet PDF Preview Sync, Exact Coordinates & 7-Sheet XLSX Export', () => {
        it('AUT-FRONT-91: Verifies reactive studio sync across all sheets, live sync badges, exact PDF coordinates, and v=2.70', () => {
            ...
            assert.strictEqual(
                ...
                true,
                'REV-200: Quotation and Billing keep their own items (the Job Order no longer overwrites them)'
            );
    ...
    describe('Suite 49: REV-121 Quotation_No & Billing_No Dynamic PDF Compiler & Form Alignment', () => {
        ...
        it('AUT-FRONT-117: REV-158 Billing Form 3/3 Measured Vector Alignment & Border-Safe Ghost Masking', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.56"') || indexHtml.includes('src="js/app.js?v=3.55"') || indexHtml.includes('src="js/app.js?v=3.54"') || indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"') || indexHtml.includes('src="js/app.js?v=3.51"') || indexHtml.includes('src="js/app.js?v=3.50"') || indexHtml.includes('src="js/app.js?v=3.49"') || indexHtml.includes('src="js/app.js?v=3.48"') || indexHtml.includes('src="js/app.js?v=3.47"') || indexHtml.includes('src="js/app.js?v=3.46"') || indexHtml.includes('src="js/app.js?v=3.45"') || indexHtml.includes('src="js/app.js?v=3.44"') || indexHtml.includes('src="js/app.js?v=3.43"') || indexHtml.includes('src="js/app.js?v=3.42"') || indexHtml.includes('src="js/app.js?v=3.41"') || indexHtml.includes('src="js/app.js?v=3.40"') || indexHtml.includes('src="js/app.js?v=3.39"') || indexHtml.includes('src="js/app.js?v=3.38"') || indexHtml.includes('src="js/app.js?v=3.37"') || indexHtml.includes('src="js/app.js?v=3.36"') || indexHtml.includes('src="js/app.js?v=3.35"') || indexHtml.includes('src="js/app.js?v=3.34"') || indexHtml.includes('src="js/app.js?v=3.33"') || indexHtml.includes('src="js/app.js?v=3.32"') || indexHtml.includes('src="js/app.js?v=3.31"') || indexHtml.includes('src="js/app.js?v=3.30"') || indexHtml.includes('src="js/app.js?v=3.29"') || indexHtml.includes('src="js/app.js?v=3.28"') || indexHtml.includes('src="js/app.js?v=3.27"') || indexHtml.includes('src="js/app.js?v=3.26"') || indexHtml.includes('src="js/app.js?v=3.25"') || indexHtml.includes('src="js/app.js?v=3.24"') || indexHtml.includes('src="js/app.js?v=3.23"') || indexHtml.includes('src="js/app.js?v=3.22"') || indexHtml.includes('src="js/app.js?v=3.21"') || indexHtml.includes('src="js/app.js?v=3.20"') || indexHtml.includes('src="js/app.js?v=3.19"') || indexHtml.includes('src="js/app.js?v=3.18"') || indexHtml.includes('src="js/app.js?v=3.17"') || indexHtml.includes('src="js/app.js?v=3.16"') || indexHtml.includes('src="js/app.js?v=3.15"') || indexHtml.includes('src="js/app.js?v=3.14"') || indexHtml.includes('src="js/app.js?v=3.13"') || indexHtml.includes('src="js/app.js?v=3.12"') || indexHtml.includes('src="js/app.js?v=3.11"'), 'frontend/index.html must reference js/app.js?v=3.11 or higher');
        });
        ...
        it('AUT-FRONT-130: REV-171 every RO Excel Studio section header has the tinted header band', () => {
            ...
            const panes = {
                'Job Order': [pane('id="form13-editor-pane"', 'id="form13-canvas-pane"'), 5],
            ...
            ['Customer Dossier', 'Vehicle Technical Specifications', "Customer's Description of Concern", 'Diagnostic Result & Mechanic Notes']
        ...
        it('AUT-FRONT-132: REV-173 Workshop_Monitoring studio tab holds the Workshop Monitoring & Daily Intakes entry', () => {
            ...
            ['mon-input-plate', 'mon-input-model', 'f13-input-claim-stub', 'f13-input-source', 'f13-input-lane-type', 'mon-input-arrival-time', 'mon-input-referred-by']
            ...
            ['job-no', 'name', 'plate', 'model', 'category', 'sa', 'claim-stub', 'arrival', 'branch', 'source', 'referred-by', 'lane']
        ...
        it('AUT-FRONT-147: REV-188 in-app TV Monitor embeds the single Smart TV page', () => {
            ...
            assert.ok(section.includes('id="tv-inapp-frame" data-src="tv.html?embedded=1&amp;v=198" src="about:blank"'), 'In-app TV Monitor must embed tv.html?embedded=1');
        ...
        it('AUT-FRONT-150: REV-191 developer TV simulation lives only in the Ctrl+D toolbox (logged-in, development)', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.56"') || indexHtml.includes('src="js/app.js?v=3.55"') || indexHtml.includes('src="js/app.js?v=3.54"') || indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"') || indexHtml.includes('src="js/app.js?v=3.51"') || indexHtml.includes('src="js/app.js?v=3.50"') || indexHtml.includes('src="js/app.js?v=3.49"') || indexHtml.includes('src="js/app.js?v=3.48"') || indexHtml.includes('src="js/app.js?v=3.47"') || indexHtml.includes('src="js/app.js?v=3.46"') || indexHtml.includes('src="js/app.js?v=3.45"') || indexHtml.includes('src="js/app.js?v=3.44"'), 'frontend/index.html must reference js/app.js?v=3.44 or higher');
        });
        ...
        it('AUT-FRONT-151: REV-192 simple TV weather box (icon, temperature, condition) with the real reading', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.56"') || indexHtml.includes('src="js/app.js?v=3.55"') || indexHtml.includes('src="js/app.js?v=3.54"') || indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"') || indexHtml.includes('src="js/app.js?v=3.51"') || indexHtml.includes('src="js/app.js?v=3.50"') || indexHtml.includes('src="js/app.js?v=3.49"') || indexHtml.includes('src="js/app.js?v=3.48"') || indexHtml.includes('src="js/app.js?v=3.47"') || indexHtml.includes('src="js/app.js?v=3.46"') || indexHtml.includes('src="js/app.js?v=3.45"'), 'frontend/index.html must reference js/app.js?v=3.45 or higher');
        });
        ...
        it('AUT-FRONT-152: REV-193 Customer Lookup uses the RO Excel Studio sheet-tab design', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.56"') || indexHtml.includes('src="js/app.js?v=3.55"') || indexHtml.includes('src="js/app.js?v=3.54"') || indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"') || indexHtml.includes('src="js/app.js?v=3.51"') || indexHtml.includes('src="js/app.js?v=3.50"') || indexHtml.includes('src="js/app.js?v=3.49"') || indexHtml.includes('src="js/app.js?v=3.48"') || indexHtml.includes('src="js/app.js?v=3.47"') || indexHtml.includes('src="js/app.js?v=3.46"'), 'frontend/index.html must reference js/app.js?v=3.46 or higher');
        });
        ...
        it('AUT-FRONT-153: REV-194 Service_History records show real RO fields, back-job warranty and actions', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.56"') || indexHtml.includes('src="js/app.js?v=3.55"') || indexHtml.includes('src="js/app.js?v=3.54"') || indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"') || indexHtml.includes('src="js/app.js?v=3.51"') || indexHtml.includes('src="js/app.js?v=3.50"') || indexHtml.includes('src="js/app.js?v=3.49"') || indexHtml.includes('src="js/app.js?v=3.48"') || indexHtml.includes('src="js/app.js?v=3.47"'), 'frontend/index.html must reference js/app.js?v=3.47 or higher');
        });
        ...
        it('AUT-FRONT-154: REV-195 TV slides 1-3 are responsive and every area scrolls', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.56"') || indexHtml.includes('src="js/app.js?v=3.55"') || indexHtml.includes('src="js/app.js?v=3.54"') || indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"') || indexHtml.includes('src="js/app.js?v=3.51"') || indexHtml.includes('src="js/app.js?v=3.50"') || indexHtml.includes('src="js/app.js?v=3.49"') || indexHtml.includes('src="js/app.js?v=3.48"'), 'frontend/index.html must reference js/app.js?v=3.48 or higher');
        });

        it('AUT-FRONT-155: REV-196 TV auto-scrolls long lists and follows the Daily Intakes day (carry-overs stay)', () => {
            const indexHtml = fs.readFileSync(path.resolve('frontend/index.html'), 'utf8');
            const tvHtml = fs.readFileSync(path.resolve('frontend/tv.html'), 'utf8');
            const tv = fs.readFileSync(path.resolve('backend/controllers/TvController.php'), 'utf8');
            assert.ok(tv.includes("AND (date_received = ? OR status IN ('Carry Over', 'Carry-Over') OR carry_over_status <> '')") && tv.includes('$params[] = self::todayManila();'), 'Feed: today only, carry-overs always');
            assert.ok(tv.includes("public static function todayManila(): string") && tv.includes("new \\DateTimeZone('Asia/Manila')"), 'Shop date in Manila time');
            assert.ok(tvHtml.includes('const TV_AUTOSCROLL_SPEED = 40;') && tvHtml.includes('const TV_AUTOSCROLL_PAUSE_MS = 3000;') && tvHtml.includes('requestAnimationFrame(tvAutoScrollFrame);'), 'Auto-scroll down, pause, back to top');
            assert.ok(tvHtml.includes('return overflowing.filter(el => !overflowing.some(other => other !== el && el.contains(other)));'), 'Only lists that overflow (innermost) move');
            assert.ok(tvHtml.includes('if (!tvAutoScrollDone()) return;') && tvHtml.includes('const TV_AUTOSCROLL_MAX_SLIDE_MS = 120000;'), 'Slide waits until long lists were shown to the end (max 2 minutes)');
            assert.ok(tvHtml.includes('if (userActive) { st.pos = el.scrollTop;'), 'A person scrolling pauses the auto-scroll');
            assert.ok(tvHtml.includes('resetTVAutoScroll();'), 'Each slide starts at the top');
            assert.ok(indexHtml.includes('src="js/app.js?v=3.56"') || indexHtml.includes('src="js/app.js?v=3.55"') || indexHtml.includes('src="js/app.js?v=3.54"') || indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"') || indexHtml.includes('src="js/app.js?v=3.51"') || indexHtml.includes('src="js/app.js?v=3.50"') || indexHtml.includes('src="js/app.js?v=3.49"'), 'frontend/index.html must reference js/app.js?v=3.49 or higher');
        });

        it('AUT-FRONT-156: REV-197 open TVs reload on a new TV page version; returned carry-overs are tagged', () => {
            const indexHtml = fs.readFileSync(path.resolve('frontend/index.html'), 'utf8');
            const tvHtml = fs.readFileSync(path.resolve('frontend/tv.html'), 'utf8');
            const tv = fs.readFileSync(path.resolve('backend/controllers/TvController.php'), 'utf8');
            assert.ok(tv.includes("'tvVersion'  => (string)(@filemtime(dirname(__DIR__, 2) . '/frontend/tv.html') ?: ''),"), 'Feed reports the TV page version');
            assert.ok(tvHtml.includes('let tvLoadedVersion = null;') && tvHtml.includes('else if (feed.tvVersion !== tvLoadedVersion) { location.reload(); return; }'), 'TV reloads once when the version changes');
            assert.ok(tvHtml.includes("${job.carryOverStatus ? '<span class=\"tv-carryover-tag"), 'Carry-Over tag on In Service / In Queue cards');
            assert.ok(indexHtml.includes('src="js/app.js?v=3.56"') || indexHtml.includes('src="js/app.js?v=3.55"') || indexHtml.includes('src="js/app.js?v=3.54"') || indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"') || indexHtml.includes('src="js/app.js?v=3.51"') || indexHtml.includes('src="js/app.js?v=3.50"'), 'frontend/index.html must reference js/app.js?v=3.50 or higher');
        });

        it('AUT-FRONT-157: REV-198 HTML pages are never served from a stale browser cache', () => {
            const indexHtml = fs.readFileSync(path.resolve('frontend/index.html'), 'utf8');
            const htaccess = fs.readFileSync(path.resolve('.htaccess'), 'utf8');
            assert.ok(htaccess.includes('<IfModule mod_headers.c>') && htaccess.includes('<FilesMatch "\\.html$">') && htaccess.includes('Header set Cache-Control "no-cache"'), 'index.html / tv.html re-checked on every load');
            assert.ok(htaccess.includes('RewriteRule ^api/(.*)$ backend/index.php [QSA,L]'), 'API routing unchanged');
            assert.ok(indexHtml.includes('data-src="tv.html?embedded=1&amp;v=198"'), 'In-app TV frame uses a versioned link');
            assert.ok(indexHtml.includes('src="js/app.js?v=3.56"') || indexHtml.includes('src="js/app.js?v=3.55"') || indexHtml.includes('src="js/app.js?v=3.54"') || indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"') || indexHtml.includes('src="js/app.js?v=3.51"'), 'frontend/index.html must reference js/app.js?v=3.51 or higher');
        });

        it('AUT-FRONT-158: REV-199 Excel claim stub rows match the PDF (plate | model, contact once)', () => {
            const indexHtml = fs.readFileSync(path.resolve('frontend/index.html'), 'utf8');
            const appJs = fs.readFileSync(path.resolve('frontend/js/app.js'), 'utf8');
            const start = appJs.indexOf('// Customer Claim Stub (Rows 70-72)');
            const block = appJs.slice(start, appJs.indexOf('applySheetProtection(sheet1Doc);', start));
            assert.ok(start > 0 && block.includes("setCell(sheet1Doc, 'H70', plate);") && block.includes("setCell(sheet1Doc, 'J70', model);") && block.includes("setCell(sheet1Doc, 'H71', contact);"), 'Plate in H70, model in J70:K70, contact in H71');
            assert.ok(!block.includes("setCell(sheet1Doc, 'I70'") && !block.includes("setCell(sheet1Doc, 'I71'"), 'Gap cells I70 / I71 stay empty (no cut-off "ABC-", no duplicate contact)');
            assert.ok(indexHtml.includes('src="js/app.js?v=3.56"') || indexHtml.includes('src="js/app.js?v=3.55"') || indexHtml.includes('src="js/app.js?v=3.54"') || indexHtml.includes('src="js/app.js?v=3.53"') || indexHtml.includes('src="js/app.js?v=3.52"'), 'frontend/index.html must reference js/app.js?v=3.52 or higher');
        });

        it('AUT-FRONT-159: REV-200 Job Order has no parts/materials editor; Quotation/Billing keep their own items', () => {
            const indexHtml = fs.readFileSync(path.resolve('frontend/index.html'), 'utf8');
            const appJs = fs.readFileSync(path.resolve('frontend/js/app.js'), 'utf8');
            const jo = indexHtml.slice(indexHtml.indexOf('id="form13-editor-pane"'), indexHtml.indexOf('id="form13-canvas-pane"'));
            ['Parts Repeater Table', 'Materials & Consumables Repeater', 'addForm13PartRow', 'addForm13MaterialRow', 'f13-editor-grand-total', 'Estimated Job Order Total'].forEach(t => assert.ok(!jo.includes(t), `${t} removed from the Job Order tab`));
            assert.ok(jo.includes('id="f13-input-sa"') && jo.includes('id="f13-input-mechanic"'), 'Signatories stay');
            assert.ok(!appJs.includes('function syncJobOrderItemsToQuoteAndBilling()') && !appJs.includes('syncJobOrderItemsToQuoteAndBilling();'), 'Job Order no longer overwrites Quotation/Billing items');
            assert.ok(!appJs.includes('function addForm13PartRow') && !appJs.includes("desc: 'Engine Oil Filter (OEM)'"), 'No part editing or sample parts');
            assert.ok(appJs.includes('// REV-200: parts/materials in an older draft are ignored (not SA-controlled)'), 'Old drafts cannot bring parts back');
            assert.ok(appJs.includes("if (pTotal) setCell(sheet1Doc, 'G53', pTotal, true);") && appJs.includes("if (pTotal + mTotal) setCell(sheet1Doc, 'K54', pTotal + mTotal, true);"), 'Excel totals stay blank');
            assert.ok(indexHtml.includes('src="js/app.js?v=3.56"') || indexHtml.includes('src="js/app.js?v=3.55"') || indexHtml.includes('src="js/app.js?v=3.54"') || indexHtml.includes('src="js/app.js?v=3.53"'), 'frontend/index.html must reference js/app.js?v=3.53 or higher');
        });

        it('AUT-FRONT-160: REV-201 four lanes (Flexible, Express 2 hours, PMS & GRS, Priority) and a 2-hour Express limit everywhere', () => {
            const indexHtml = fs.readFileSync(path.resolve('frontend/index.html'), 'utf8');
            const appJs = fs.readFileSync(path.resolve('frontend/js/app.js'), 'utf8');
            const tvHtml = fs.readFileSync(path.resolve('frontend/tv.html'), 'utf8');
            const jc = fs.readFileSync(path.resolve('backend/controllers/JobController.php'), 'utf8');
            const studio = indexHtml.slice(indexHtml.indexOf('<select id="f13-input-lane-type"'), indexHtml.indexOf('</select>', indexHtml.indexOf('<select id="f13-input-lane-type"')));
            assert.deepStrictEqual([...studio.matchAll(/<option value="([^"]+)"/g)].map(m => m[1]), ['Flexible Lane', 'Express Lane', 'PMS & GRS Lane', 'Priority Lane'], 'Studio lane list');
            assert.ok(studio.includes('>Express Lane (2 Hours)<'), 'Express shows its 2-hour limit');
            assert.ok(!indexHtml.includes('>Special Lane<') && !indexHtml.includes('>Regular Lane<') && !appJs.includes("'Special Lane'") && !appJs.includes('Regular Lane'), 'Special / Regular lanes retired');
            assert.ok(appJs.includes("{ value: 'Express Lane', label: 'Express Lane (2 Hours)' }") && appJs.includes("{ value: 'PMS & GRS Lane', label: 'PMS & GRS Lane' }"), 'Daily Intakes lane dropdown');
            assert.ok(appJs.includes("if (str.includes('pms') || str.includes('grs')) return 'PMS & GRS Lane';") && jc.includes("if (str_contains($l, 'pms') || str_contains($l, 'grs')) return 'PMS & GRS Lane';"), 'PMS & GRS is its own lane (frontend and backend)');
            assert.ok(appJs.includes('const EXPRESS_LANE_SLA_MINUTES = 120;') && !/isExpress(Lane)? \? 60 : 120/.test(appJs), 'Express SLA 2 hours');
            assert.ok(!/60m SLA|≤ 60m|≤ 60 mins|60-minute|≤60m|> 60m/.test(indexHtml), 'No 60-minute Express text left');
            assert.ok(tvHtml.includes('>Express (≤ 2 Hours)</h3>') && tvHtml.includes('>PMS &amp; GRS Lane</h3>') && !tvHtml.includes('Specialty (Heavy Work)'), 'TV lane columns');
            assert.ok(indexHtml.includes('src="js/app.js?v=3.56"') || indexHtml.includes('src="js/app.js?v=3.55"') || indexHtml.includes('src="js/app.js?v=3.54"'), 'frontend/index.html must reference js/app.js?v=3.54 or higher');
        });

        it('AUT-FRONT-161: REV-202 registered ROs are same-day jobs (promise date is not carry-over); C.O. and Job Order category removed', () => {
            const indexHtml = fs.readFileSync(path.resolve('frontend/index.html'), 'utf8');
            const appJs = fs.readFileSync(path.resolve('frontend/js/app.js'), 'utf8');
            assert.ok(!indexHtml.includes('f13-input-carry-over') && !indexHtml.includes('Carry-Over (C.O.)') && !indexHtml.includes('mon-sum-carry-over'), 'Carry-Over (C.O.) field and summary removed');
            assert.ok(!appJs.includes('f13-input-carry-over') && !appJs.includes('carryOver: carryOver'), 'No C.O. value sent');
            assert.ok(appJs.includes("${(job.carryOverStatus || job.status === 'Carry Over') ? `") && !appJs.includes('(job.promisedDate || job.carryOverStatus) ?'), 'Carry-Over tag only for real carry-overs');
            assert.ok(!appJs.includes('!j.promisedDate && !j.carryOverStatus') && !appJs.includes('(j.promisedDate || j.carryOverStatus'), 'Promise date no longer counts as carry-over');
            assert.ok(indexHtml.includes('<div class="hidden" aria-hidden="true">\n                                    <label class="block text-[11px] font-medium text-gray-500 mb-1">Service Category</label>') || indexHtml.includes('<div class="hidden" aria-hidden="true">\r\n                                    <label class="block text-[11px] font-medium text-gray-500 mb-1">Service Category</label>'), 'Job Order Service Category hidden (kept as the stored value)');
            assert.ok(indexHtml.includes('id="mon-input-category"'), 'Service Category chosen on Workshop_Monitoring');
            assert.ok(indexHtml.includes('src="js/app.js?v=3.56"') || indexHtml.includes('src="js/app.js?v=3.55"'), 'frontend/index.html must reference js/app.js?v=3.55 or higher');
        });

        it('AUT-FRONT-162: REV-203 claim stubs assigned by the server in order (MMDDYY + J + customer number, Manila day)', () => {
            const indexHtml = fs.readFileSync(path.resolve('frontend/index.html'), 'utf8');
            const appJs = fs.readFileSync(path.resolve('frontend/js/app.js'), 'utf8');
            const jc = fs.readFileSync(path.resolve('backend/controllers/JobController.php'), 'utf8');
            const router = fs.readFileSync(path.resolve('backend/index.php'), 'utf8');
            const db = fs.readFileSync(path.resolve('database.sql'), 'utf8');
            assert.ok(jc.includes("(new \\DateTime('now', new \\DateTimeZone('Asia/Manila')))->format('mdy')"), 'Manila date');
            assert.ok(jc.includes('ON DUPLICATE KEY UPDATE last_no = LAST_INSERT_ID(GREATEST(last_no + 1, ?))') && jc.includes("return $datePrefix . 'J' . $next;"), 'Atomic per-day counter, never below a number already used');
            assert.ok(jc.includes("$claimStub      = '';") && jc.includes("if ($initialStatus !== 'Pending') {\n                $claimStub = self::generateStubNumber();") || jc.includes("if ($initialStatus !== 'Pending') {\r\n                $claimStub = self::generateStubNumber();"), 'Client stub ignored; every vehicle entering the floor is numbered');
            assert.ok(!jc.includes("'claimStub'          => 'claim_stub',"), 'Claim stub cannot be edited');
            assert.ok(router.includes("$route === '/jobs/next-claim-stub'") && db.includes('CREATE TABLE IF NOT EXISTS `claim_stub_counters`'), 'Preview route and counter table');
            assert.ok(indexHtml.includes('id="f13-input-claim-stub" readonly'), 'Studio field is read-only');
            assert.ok(appJs.includes("apiRequest('/api/jobs/next-claim-stub')") && appJs.includes('const assignedStub = createdJob?.claimStub'), 'Studio shows the server preview and the assigned number');
            assert.ok(indexHtml.includes('src="js/app.js?v=3.56"'), 'frontend/index.html must reference js/app.js?v=3.56');
        });
    });
});
