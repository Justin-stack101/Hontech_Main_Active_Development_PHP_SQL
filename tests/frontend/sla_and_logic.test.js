...
describe('Suite 13: Daily Intakes 3-Table Alignment, Spacing Rhythm & Command Deck (REV-082)', () => {
    ...
    describe('Suite 49: REV-121 Quotation_No & Billing_No Dynamic PDF Compiler & Form Alignment', () => {
        ...
        it('AUT-FRONT-125: REV-166 Brake Condition has an independent status per wheel across UI, PDF and Excel', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.23"') || indexHtml.includes('src="js/app.js?v=3.22"') || indexHtml.includes('src="js/app.js?v=3.21"') || indexHtml.includes('src="js/app.js?v=3.20"') || indexHtml.includes('src="js/app.js?v=3.19"'), 'frontend/index.html must reference js/app.js?v=3.19 or higher');
        });
        ...
        it('AUT-FRONT-126: REV-167 Checklist checkpoints are selection-only (no per-item notes box)', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.23"') || indexHtml.includes('src="js/app.js?v=3.22"') || indexHtml.includes('src="js/app.js?v=3.21"') || indexHtml.includes('src="js/app.js?v=3.20"'), 'frontend/index.html must reference js/app.js?v=3.20 or higher');
        });
        ...
        it('AUT-FRONT-127: REV-168 Checklist section headers use a gray band with black text', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.23"') || indexHtml.includes('src="js/app.js?v=3.22"') || indexHtml.includes('src="js/app.js?v=3.21"'), 'frontend/index.html must reference js/app.js?v=3.21 or higher');
        });
        ...
        it('AUT-FRONT-128: REV-169 Shared PDF toolbar and CheckList-style editors on Job Order, Quotation and Billing', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.23"') || indexHtml.includes('src="js/app.js?v=3.22"'), 'frontend/index.html must reference js/app.js?v=3.22 or higher');
        });
        ...
        it('AUT-FRONT-129: REV-170 PDF and Excel share one set of data, line-item and totals rules', () => {
            ...
            assert.ok(indexHtml.includes('src="js/app.js?v=3.23"'), 'frontend/index.html must reference js/app.js?v=3.23');
        });
    });
});
