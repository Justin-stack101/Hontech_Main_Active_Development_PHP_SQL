...
describe('Suite 13: Daily Intakes 3-Table Alignment, Spacing Rhythm & Command Deck (REV-082)', () => {
    ...
    describe('Suite 45: REV-117 SA 2025 RO Studio PDF Typography & Non-Bold Formatting Alignment with Excel Template', () => {
        it('AUT-FRONT-94: Verifies authentic regular non-bold fonts and exact text sizes matching Excel template', () => {
            ...
            assert.strictEqual(
                (indexHtml.includes('src="js/app.js?v=3.10"') || indexHtml.includes('src="js/app.js?v=3.09"') || indexHtml.includes('src="js/app.js?v=3.08"') || indexHtml.includes('src="js/app.js?v=3.07"')) || indexHtml.includes('src="js/app.js?v=3.06"') || indexHtml.includes('src="js/app.js?v=3.05"') || indexHtml.includes('src="js/app.js?v=3.04"') || (indexHtml.includes('src="js/app.js?v=3.10"') || indexHtml.includes('src="js/app.js?v=3.09"') || indexHtml.includes('src="js/app.js?v=3.08"') || indexHtml.includes('src="js/app.js?v=3.07"')) || indexHtml.includes('src="js/app.js?v=3.06"') || indexHtml.includes('src="js/app.js?v=3.05"') || indexHtml.includes('src="js/app.js?v=3.04"') || indexHtml.includes('src="js/app.js?v=3.03"') || indexHtml.includes('src="js/app.js?v=3.02"') || indexHtml.includes('src="js/app.js?v=3.01"') || indexHtml.includes('src="js/app.js?v=3.00"') || indexHtml.includes('src="js/app.js?v=2.99"') || indexHtml.includes('src="js/app.js?v=2.98"'),
                true,
    ...
    describe('Suite 49: REV-121 Quotation_No & Billing_No Dynamic PDF Compiler & Form Alignment', () => {
        ...
        it('AUT-FRONT-111: REV-157 Quotation Form 2/3 Exact Visual Vector Alignment & Border-Safe Masking', () => {
            ...
            // 5. Cache buster v=3.10
            assert.strictEqual(
                indexHtml.includes('src="js/app.js?v=3.10"'),
                true,
                'frontend/index.html must reference js/app.js?v=3.10'
            );
        });
    });
});
